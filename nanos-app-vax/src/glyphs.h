...
extern unsigned int const C_icon_toggle_reset_colors[];
extern unsigned char const C_icon_toggle_reset_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
...
extern unsigned int const C_icon_toggle_set_colors[];
extern unsigned char const C_icon_toggle_set_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
